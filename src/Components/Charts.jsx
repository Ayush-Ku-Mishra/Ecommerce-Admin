...
//     monthNames.map(m => ({ month: m, TotalUsers: 0, TotalSales: 0 }))
//   );
//   const [hoveredData, setHoveredData] = useState(null);
...
//           axios.get("/api/v1/user/users-by-month", { withCredentials: true }),
//           axios.get("/api/v1/payment/sales-by-month", { withCredentials: true })
//         ]);
...
//           newData[monthIndex].TotalUsers = item.count;
//         });

//         // Fill sales
//         salesRes.data.data.forEach(item => {
//           const monthIndex = item._id - 1;
//           newData[monthIndex].TotalSales = item.totalSales;
//         });
...
//         <div className="bg-gray-800 text-white p-2 rounded shadow-lg">
//           <p className="text-yellow-400 font-bold">{label}</p>
//           <p className="text-blue-400">TotalUsers: {d.TotalUsers}</p>
//           <p className="text-cyan-400">
//             TotalSales: {d.TotalSales.toLocaleString()}
//           </p>
//         </div>
...
//               <Bar dataKey="TotalUsers" fill="#3b82f6" radius={[2, 2, 0, 0]} />
//               <Bar dataKey="TotalSales" fill="#16A34A" radius={[2, 2, 0, 0]} />
//             </BarChart>
//           </ResponsiveContainer>
//         </div>
