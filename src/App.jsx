    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "reviews-dashboard", element: <ReviewsAdmin /> },
          { path: "reported-reviews", element: <ReviewsAdmin activeTab="reported" /> },
          { path: "review-analytics", element: <ReviewsAdmin activeTab="overview" /> },
        ],
      },
    ],
  },
